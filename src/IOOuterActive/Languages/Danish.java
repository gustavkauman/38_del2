...
public class Danish {
    ...
    public void wereWall() {
        System.out.println("Tro det eller ej, en mur lavet af varulve! Du mister en arm og 80 guldklumper, men tag en tur til");
    }
    ...
    public void winner() {
        System.out.print("Tillyke! Vinderen af spillet er ");
    }

    public void balanceOut() {
        System.out.print("Nuværende saldo: ");
    }

    public void moneyWithdrawal() {
        System.out.print("Transaktionen er gennemført. Du er blevet trukket ");
    }

    public void moneyDeposit() {
        System.out.print("Transaktionen er gennemført. Din konto er blevet tilføjet ");
    }

    public void insufficientFunds() {
        System.out.print("Transaktionen er blevet genneført. Din konto er sat til 0, da du ikke har nok penge i forsøget på at hæve ");
    }
}
